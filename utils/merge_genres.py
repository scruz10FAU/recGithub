GENRE_KEYWORDS1 = {
    ...
    "Systems / Embedded / Robotics": [
        ...
        # OS / window managers / desktop environment core / system-level runtimes
        ...
        # powerful desktop tooling / power user utilities
    ...
    "Web / Mobile / Application Development": [
        # web frameworks / frontend / fullstack / ui apps / note apps
        ...
        "searchparams", "url",
        # distribution / hosting keywords
        "selfhosted", "self-hosted", "self-hosting"
    ],

    "DevOps / Infrastructure / Cloud": [
        # containers / orchestration / cloud infra / secrets / uptime / storage
    ...
    "Security / Networking": [
        # security / exploit / osint / privacy / crypto
    ...
    "Data Platforms / Backend Services / Integrations": [
        # databases / backends / services / brokers / apis / integrations
        ...
        "cloud", "oss", "foss", "open-source", "opensource", "free-software",
        "self-hosted", "selfhosted", "self-hosting"
    ],

    "CLI / Utilities / Developer Tools": [
        # cli tools / terminals / shells / developer helpers / editors
    ...
    "Libraries / SDKs / Framework Components": [
        # reusable code, SDKs, components, frameworks, ui kits
    ...
    "Research / Experiments / Demos": [
        # research / experiments / prototypes / awesome lists for exploration
        ...
        # learning playgrounds / awesome lists / exploratory collections
    ...
    "Education / Tutorials / Docs": [
        # educational content / curriculum / how-to / beginner-friendly
...
def merge_genre_keywords(GENRE_OLD, GENRE_NEW):
    merged = {}

    # get all genre names from both dicts
    all_genres = set(GENRE_OLD.keys()) | set(GENRE_NEW.keys())

    for genre in all_genres:
        old_list = GENRE_OLD.get(genre, [])
        new_list = GENRE_NEW.get(genre, [])

        # union while preserving everything
        merged_list = list(dict.fromkeys(old_list + new_list))
        # dict.fromkeys(...) preserves order of first appearance and removes duplicates

        merged[genre] = merged_list

    return merged

GENRE_KEYWORDS = merge_genre_keywords(GENRE_KEYWORDS1, GENRE_KEYWORDS2)
